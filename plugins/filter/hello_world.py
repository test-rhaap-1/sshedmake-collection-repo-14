"""A hello-world filter plugin in sshedmake_namespace_14.myrhdh_14."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_14 Myrhdh_14
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_14.myrhdh_14.hello_world }}"
"""
